...
if __name__ == "__main__":
    ...
    print("two bucket solution", t.timeit(two_bucket_solution, number=100))
    print(two_bucket_solution())
    print("solution", t.timeit(solution, number=100))
    print(solution())
    print("ba_solution", t.timeit(ba_solution, number=100))
    print(ba_solution())
